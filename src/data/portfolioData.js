...
export const consulting = {
  ...
  body:
    '코로나 시기, 제품력은 검증됐으나 고객 도달 수단이 없던 개인 파티셰리 브랜드 Raison D\'être에 브랜드, CX, SNS, 운영을 아우르는 통합 컨설팅을 제안하고 실행까지 담당. 광고 예산과 담당 인력이 없는 조건에 맞춰 방송 출연, 백화점 팝업 등 외부 협업으로 노출을 확보하고, 로고, 패키지, 매장 톤을 통일한 뒤 생산 거점 한 곳에서 판매 매장을 늘리는 방식으로 확장. 매장 1개에서 3개로 확장하는 과정에 참여 (서울 주요 상권), 인스타그램 팔로워 1만 달성.',
...
export const projects = [
  {
    ...
    featured: true,
    summary:
      '글로벌 Encore를 그대로 적용하는 대신 한국형 프로그램을 별도로 설계하는 안을 HQ에 제안해 승인받아, \'Lexus Amazing Members\'의 설계와 런칭을 PM으로 총괄했습니다. 오너 전용 3단 티어와 라이프스타일 경험 베네핏으로, 구매 이후에도 프리미엄 경험이 이어지는 로열티 구조를 구축했습니다.',
    impact: 'VIP 케어 이미지 +3.0p',
    challenge: [
      '글로벌 로열티 프로그램이 한국 오너 기대와 불일치, VIP 케어 이미지 12.8로 경쟁 프리미엄 브랜드 대비 열위',
      '구매 이후에도 프리미엄 경험이 이어진다는 오너 인식 확보 필요',
      '한국 오너 기준으로 설계된 티어와 베네핏의 부재',
    ],
    approach: [
      '오너 세그먼트: 구매 모델, 구매 시점, 관계 유지 여부 세 기준으로 분류',
      '오너 전용 3단 티어: 플래그십 최초 출고, 전 모델 출고, 재구매와 서비스 입고 유지. 비오너 엔트리 티어 배제',
      '경험형 베네핏: 할인 대신 라이프스타일 경험 프로그램으로 구성',
      '앱 한정 운영: 티어 확인과 베네핏 사용을 브랜드 앱으로 한정, 앱 가입 동기와 오너 데이터 축적',
      '플래그십 우선 적용: 한국형 별도 설계안을 HQ에 제안해 승인, 플래그십 오너부터 적용해 반응 데이터로 전 모델 확장 시점 결정',
    ],
    outcomeQualitative: [
  ...
  },
  {
    ...
    challenge: [
      ...
      '과제는 데이터 통합과 서비스 온라인화',
    ],
    approach: [
      '출고 시점 가입: 출고 프로세스에 앱 가입을 결합, 이후 로열티 티어 확인을 앱으로 한정해 진입 동기 강화',
      '정비 예약 우선: 오너 이용 빈도가 가장 높은 접점에서 습관 형성, 입고 이력을 데이터로 축적',
      'KPI 2개 고정: 신차 오너 등록률과 온라인 예약 비중. 기능 개발 순서는 요청 순이 아닌 KPI 기여도 순',
      '마일리지 연결: 신규 가입, 추천, 재구매, 서비스 입고, 온라인 쇼핑 다섯 접점에 적립',
      '단계별 통합: 대리점 데이터 통합은 프로덕트 조직과 대리점 협업으로 단계별 진행',
    ],
    outcomeQualitative: [
      '온라인 예약 비중 20% (오프라인 100% 의존에서 전환)',
      '신차 오너 약 90% 앱 가입 (2025 기준), 전체 회원 약 9만, MAU 1.5~2만',
  ...
  },
  {
    ...
    challenge: [
      ...
      '페르소나 정의와 대리점 세일즈 언어 부재',
    ],
    approach: [
      'KPI 이원화: 사전계약 수량과 프리미엄 이미지 지표를 함께 설정, 경쟁 프리미엄 브랜드 전년 수치로 벤치마크',
      '페르소나 재정의: 구매 이력이 아닌 럭셔리 라이프스타일 소비층으로 타깃 정의',
      '2단계 런칭: 사전런칭에서 사전계약 확보, 시장 반응으로 정식 런칭 메시지 확정',
      '여정 통합: 인지는 광고, 접촉은 경험 프로그램, 전환은 대리점으로 설계',
      '대리점 표준화: 모델별 세일즈 키트로 판매 언어 통일, 온라인 콘텐츠와 동일 메시지',
    ],
    outcomeQualitative: [
  ...
  // ── 06. 개인 프로젝트 — 레종데트르 ──
  {
    ...
    isPersonal: true,
    summary:
      '코로나 시기, 제품력은 검증됐으나 고객 도달 수단이 없던 개인 파티셰리 브랜드에 브랜드, CX, SNS, 운영을 아우르는 통합 컨설팅을 제안하고 실행까지 담당했습니다.',
    impact: '매장 1개 → 3개 확장 과정 참여 · 인스타그램 팔로워 1만',
    challenge: [
      '코로나 시기, 제품력은 검증됐으나 고객 도달 수단 부재, 생존이 과제',
      '맛 이상의 경험으로 인식되는 브랜드, 그 인식 위에서의 안정적 운영과 확장 필요',
      '도달 수단과 확장 구조의 부재',
    ],
    approach: [
      '소규모 브랜드 기준으로 설계: 광고 예산 없음, 마케팅 담당자 없음, 하루 1~2시간. 이 조건에서 유지되는 방법만 선택',
      '외부 협업으로 노출 확보: 광고 대신 방송 출연, 백화점 팝업 등 노출 기회를 제안하고 성사. 이 노출이 매장 확장의 계기',
      '생산 효율화: 로고, 패키지, 매장 톤을 먼저 통일한 뒤 생산 거점 한 곳에서 판매 매장 확장',
    ],
    outcomeQualitative: [
