...
export const consulting = {
  ...
  body:
    '상품성은 뛰어나지만 고객에게 어떻게 다가갈지가 과제였던 개인 파티셰리 브랜드 Raison D\'être에, 맛 이상의 경험을 제공하는 방향으로 브랜드, CX, SNS, 운영을 아우르는 통합 컨설팅을 제안하고 실행까지 담당. 로고, 패키지, 매장 톤을 다시 잡고 인스타그램을 메인 채널로 설계했으며, 매장 1개에서 3개로 확장하는 과정에 참여 (서울 주요 상권), 인스타그램 팔로워 1만 달성.',
...
export const projects = [
  {
    ...
    approach: [
      '글로벌 Encore를 부분 수정해 적용하는 대신 한국형 프로그램을 별도로 설계하는 안을 HQ에 제안',
      '첫 대상을 전 고객이 아닌 플래그십 고객으로 한정 — 반응 데이터를 빨리 모아 확장 근거로 활용',
  ...
  },
  {
    ...
    featured: true,
    summary:
      '대리점별로 흩어진 고객 데이터를 브랜드 앱으로 통합하고, 오프라인 100% 의존이던 정비 예약을 온라인 20%로 전환했습니다. 신차 고객 약 90%(2025 기준)가 앱에 가입했고 전체 회원 약 9만·MAU 1.5–2만을 달성했습니다.',
  ...
  },
  {
    ...
    approach: [
      '럭셔리 라이프스타일을 공유하는 신규 타깃군을 우선 대상으로 설정',
      '런칭 플랜부터 광고 전략, 고객 경험 프로그램까지 하나의 흐름으로 설계',
      '사전런칭을 먼저 두고 정식 런칭을 뒤에 배치 — 시장 반응을 보고 정식 런칭 메시지 확정',
      '대리점 지원을 개별 대응이 아닌 표준 세일즈 키트 배포로 통일',
      '사전계약 추이와 브랜드 서베이로 성과 점검, 다음 액션 조정',
    ],
    outcomeQualitative: [
      'RX 사전계약 계획 대비 131%, LM 5개월 사전계약 목표 100% 달성',
  ...
  // ── 06. 개인 프로젝트 — 레종데트르 ──
  {
    ...
    isPersonal: true,
    summary:
      '상품성은 뛰어나지만 고객에게 어떻게 다가갈지가 과제였던 개인 파티셰리 브랜드에, 맛 이상의 경험을 제공하는 방향으로 브랜드, CX, SNS, 운영을 아우르는 통합 컨설팅을 제안하고 실행까지 담당.',
    impact: '매장 1개 → 3개 확장 과정 참여 · 인스타그램 팔로워 1만',
    challenge: [
      '상품성은 뛰어나나 고객에게 어떻게 다가갈지가 과제',
      '"맛있는 것 이상의 경험"을 고객이 인식하게 만드는 것이 과제',
      '개인 파티셰리의 브랜드화를 통한 규모 확장 필요',
    ],
    approach: [
      '브랜드, CX, SNS, 운영을 하나로 묶은 통합 제안 — 인하우스 방식을 소규모 브랜드 리소스에 맞게 재설계',
      '로고, 패키지, 매장 톤을 맛 이상의 경험에 맞춰 다시 설계',
      '인스타그램을 메인 채널로 정하고 콘텐츠 톤과 운영 원칙 수립',
      '소규모 인력으로 유지할 수 있는 범위에서 운영 우선순위 조정',
      '매장을 늘리기 전에 브랜드 정체성을 먼저 고정 — 매장이 늘어도 같은 경험이 유지되도록 설계',
    ],
    outcomeQualitative: [
    ...
    outcomeMetrics: [
      { label: '매장 확장', value: '1개 → 3개 (서울 주요 상권)' },
...
export const timeline = [
  ...
  },
  {
    ...
    description:
      '대리점별로 흩어진 고객 데이터를 브랜드 앱으로 통합, 오프라인 정비 프로세스 100% 디지털화. 오프라인 100% → 온라인 정비 예약 20%, 신차 고객 약 90%(2025 기준) 앱 가입, 전체 회원 9만·MAU 1.5–2만 달성.',
    pillars: ['dx'],
  },
  {
    id: 'timeline-4',
