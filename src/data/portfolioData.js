...
export const projects = [
  {
    ...
    approach: [
      ...
      '경험형 베네핏: 가격 할인 대신 라이프스타일 경험 프로그램으로 구성, 프리미엄 포지셔닝 유지',
  ...
  },
  {
    ...
    approach: [
      ...
      '정비 예약 우선: 이용 빈도가 가장 높은 접점에서 앱 사용 습관 형성, 입고 이력을 고객 데이터로 축적',
  ...
  },
  {
    ...
    challenge: [
      ...
      '페르소나 정의와 대리점 세일즈 메시지 표준 부재',
    ],
    approach: [
      'KPI 이원화: 사전계약 수량과 프리미엄 이미지 지표를 함께 설정, 경쟁 프리미엄 브랜드 전년 수치로 벤치마크',
      '페르소나 재정의: 구매 이력이 아닌 럭셔리 라이프스타일 소비층으로 타깃 정의',
      '2단계 런칭: 사전런칭으로 사전계약과 시장 반응을 먼저 확보, 이를 근거로 정식 런칭 메시지 확정',
      '여정 통합: 인지는 광고, 접촉은 경험 프로그램, 전환은 대리점으로 설계',
      '대리점 표준화: 모델별 세일즈 키트로 세일즈 메시지 표준화, 온라인 콘텐츠와 동일 메시지',
    ],
    outcomeQualitative: [
      '주력 SUV 모델(RX) 2022 런칭, 사전계약 131% 달성으로 목표 초과',
      '플래그십 모델(LM) 2024 런칭, 사전계약 5개월 목표 100% 달성',
      '프리미엄 브랜드 이미지 +2.9p (19.5 → 22.4, 목표 22.2)',
      '2단계 런칭 프로세스를 후속 모델 런칭에 적용, 세일즈 키트를 표준 포맷으로 정착',
    ],
    outcomeMetrics: [
      { label: 'RX 사전계약 (2022)', value: '131% · 목표 초과' },
      { label: 'LM 사전계약 (2024)', value: '5개월 목표 100%' },
      { label: '프리미엄 이미지', value: '+2.9p (19.5 → 22.4)' },
    ],
  ...
  // ── 06. 개인 프로젝트 — 레종데트르 ──
  {
    ...
    impact: '서울 주요 상권 매장 확장 참여 · 인스타그램 팔로워 1만',
    challenge: [
    ...
    outcomeQualitative: [
      '서울 주요 상권 매장 확장 과정에 브랜드, 협업, 운영 설계로 참여, 인스타그램 팔로워 1만',
